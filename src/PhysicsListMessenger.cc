  ...
  :list(alist)
{
  ...
  selectIonInelasticProcess = new G4UIcmdWithAString("/physics/setIonInelasticProcess",this);
  selectIonInelasticProcess->SetGuidance("Select one of the model for Ion inelastic interaction");
  selectIonInelasticProcess->SetParameterName("setIonInelasticProcess",false);
  selectIonInelasticProcess->AvailableForStates(G4State_PreInit,G4State_Idle);
